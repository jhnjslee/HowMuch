 ...
 * Use the [SeventhQuestion.newInstance] factory method to
...
class SeventhQuestion : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_seventh_question, container, false)
        ...
        val radioGroup8 = view.findViewById(R.id.rg8) as RadioGroup
        radioGroup8.setOnCheckedChangeListener { group, checkedId ->
            val radioButton = view.findViewById(checkedId) as RadioButton
            result[7] = radioButton.text as String
            Log.d("1", checkedId.toString() +" "+ radioButton.text)
        }
        ...
        nextBtn.setOnClickListener {
            if (checkOk(result)) {
                ...
                (activity as Question?)?.replaceFragment(EighthQuestion.newInstance("", ""), "", "")
            } else {
                //Toasty
    ...
    fun sumSecondQuestion(array: Array<String>){
         ...
         * @return A new instance of fragment SeventhQuestion.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SeventhQuestion().apply {
