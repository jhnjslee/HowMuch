 ...
 * Use the [SixthQuestion.newInstance] factory method to
...
class SixthQuestion : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_sixth_question, container, false)
        ...
        nextBtn.setOnClickListener {
            if (checkOk(result)){
                ...
                (activity as Question?)?.replaceFragment(SeventhQuestion.newInstance("",""),"","")
            }else{
                //Toasty
    ...
    companion object {
         ...
         * @return A new instance of fragment SixthQuestion.
         */
