 ...
 * Use the [NinthQuestion.newInstance] factory method to
...
class NinthQuestion : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_ninth_question, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment NinthQuestion.
         */
