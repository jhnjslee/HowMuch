 ...
 * Use the [EighthQuestion.newInstance] factory method to
...
class EighthQuestion : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_eighth_question, container, false)
        ...
        nextBtn.setOnClickListener {
            if (checkOk(result)){
                ...
                (activity as Question?)?.replaceFragment(NinthQuestion.newInstance("",""),"","")
            }else{
                //Toasty
